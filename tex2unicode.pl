#!@perl@
#
# Original version by Ilya Zakharevich.
# (Original changelog is at end of this file)
# Minor updates by the PARI group.
# Some Unicode support was added 9 June 2012.
# Minoor updates by Pomax in October 2020.
#
# Options:
#  linelength=75  # Wrap lines at this line.
#  maxdef=400     # Definition loops: exit if many substitutions.
#  debug=0        # Debugging/overly-verbose flag.
#  by_par=0       # Expect each paragraph to be terminated
#                 # by *exactly* 2 "\n", and do not print
#                 # an extra "\n" between paragraphs.
#  TeX            # Assume plain TeX rather than LaTeX
#  ragged         # Leave right ragged.
#  noindent       # Assume \noindent everywhere.
#  ignorefonts    # Make math fonts (\mathfrak etc) NOPs.
#  scissors       # Symbol to insert when a long line is cut.
#
use utf8;
binmode STDOUT, ":utf8";
